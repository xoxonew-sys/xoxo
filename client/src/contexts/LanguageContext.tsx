...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "referral.title": "Arkadaşını getir",
    "referral.hint": "Kodunu paylaş. Katılan 50, sen 100 X-Kredi kazan.",
    "referral.code": "Davet kodun",
    "referral.copied": "Kod kopyalandı",
    "referral.share": "Paylaş",
    "referral.used": "davet",
    "referral.remaining": "hak kaldı",
    "referral.exhausted": "Davet hakkın doldu.",
    "referral.share_text": "XOXO Gossip AI'da bana katıl. Bu kodla 50 X-Kredi hediye: ",
    "auth.referral_code": "Davet kodu (varsa)",
  ...
  en: {
    ...
    "referral.hint": "Share your code. They get 50, you get 100 X-Credits.",
    "referral.code": "Your invite code",
    "referral.copied": "Code copied",
    "referral.share": "Share",
    "referral.used": "invited",
    "referral.remaining": "left",
    "referral.exhausted": "You've used all your invites.",
    "referral.share_text": "Join me on XOXO Gossip AI. Use this code for 50 free X-Credits: ",
    "auth.referral_code": "Invite code (optional)",
